// удаление слов, в которых присутствуют только цифры
// export TEST_FILE='out.txt' // установка переменной
// env // вывод всех переменных
// set | grep TEST_FILE // проверка. данная переменная доступна только
// в текущей сессии
// echo $TEST_FILE // вывод значения переменной
// unset TEST_FILE //полностью отвязать переменную от оболочки
        .arch   armv8-a
        .data
mes2:
